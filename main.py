...
def main():
    #step 1 - downlaod google's pre-trained neural network
    url = 'https://storage.googleapis.com/download.tensorflow.org/models/inception5h.zip'
    data_dir = '/home/sampark/Documents/deep_dream_tf'
    ...
    def render_deepdream(t_obj, img0=img_noise, iter_n = 25, step = 1.5, octave_n=4, octave_scale=1.4):
        ...
        for ocatve in range(octave_n):
            ...
            #Step 5 - output deep dreamed img
            showarray(img/255.0)
